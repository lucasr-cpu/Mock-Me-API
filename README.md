...
**Sensitive data generators (credit cards, SSNs, EINs) produce obviously fake values prefixed with "FAKE-" or starting with "9xx". Do NOT use generated values in real payment processing, identity verification, or any production systems that handle sensitive information.**
